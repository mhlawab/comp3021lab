...
public class Heap<T extends Comparable<T>> {
    ...
    private void heapifyUp() {
        // TODO
    	while (hasParent(container.size()-1) && 
    			container.get(container.size()-1).compareTo(container.get(getParentIndex(container.size()-1)))<0) {
    		swap(container.size()-1,getParentIndex(container.size()-1));
    	}
    }
